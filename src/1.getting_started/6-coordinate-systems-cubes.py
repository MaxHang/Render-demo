...
def main():
    ...
    while not glfw.window_should_close(window):
        ...
        # projection = glm.perspective(glm.radians(75.0), width / height, 0.1, 100.0)
        projection = glm.perspective(glm.radians(45.0), 0.5 * width / height, 0.1, 100.0)
        gl.glBindVertexArray(vao)
