...
def main():
    ...
    shader = Shader(r'res/shaders/4.2-texture.shader')

    vertices = [
     # positions         colors          tex_coords
     0.5,  0.5, 0.0,  1.0, 0.0, 0.0,   2.0,  2.0,  # top right
     0.5, -0.5, 0.0,  0.0, 1.0, 0.0,   2.0, -1.0,  # bottom right
    -0.5, -0.5, 0.0,  0.0, 0.0, 1.0,  -1.0, -1.0,  # bottom left
    -0.5,  0.5, 0.0,  1.0, 1.0, 0.0,  -1.0,  2.0,  # top left
    ]
    ...
    # -- texture wrapping
    gl.glTexParameter(gl.GL_TEXTURE_2D, gl.GL_TEXTURE_WRAP_S, gl.GL_MIRRORED_REPEAT)
    gl.glTexParameter(gl.GL_TEXTURE_2D, gl.GL_TEXTURE_WRAP_T, gl.GL_MIRRORED_REPEAT)
    # -- texture filterting
    gl.glTexParameter(gl.GL_TEXTURE_2D, gl.GL_TEXTURE_MIN_FILTER, gl.GL_LINEAR)
    gl.glTexParameter(gl.GL_TEXTURE_2D, gl.GL_TEXTURE_MAG_FILTER, gl.GL_LINEAR)
