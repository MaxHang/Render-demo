...
def main():
    ...
    lighting_shader = Shader("src/2.lighting/shaders/6.multiple_lights.vs", "src/2.lighting/shaders/6.multiple_lights.fs")
   ...
   # -- position attribute
    ...
    while not glfw.window_should_close(window):
        ...
        # -- spotLight
        lighting_shader.set_vec3("spotLight.position", glm.value_ptr(camera.position))
        lighting_shader.set_vec3("spotLight.direction", glm.value_ptr(camera.front))
