...
def main():
    ...
    lighting_shader = Shader("src/2.lighting/shaders/4.3.lighting_maps.vs", "src/2.lighting/shaders/4.3.lighting_maps.fs")
   ...
   # -- position attribute
    ...
    while not glfw.window_should_close(window):
        ...
        lighting_shader.set_float('time', glfw.get_time())
