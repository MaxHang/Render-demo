...
def main():
    ...
    lighting_shader = Shader("src/2.lighting/shaders/2.2.basic_lighting.vs", "src/2.lighting/shaders/2.2.basic_lighting.fs")
    ...
    while not glfw.window_should_close(window):
        ...
        lighting_shader.set_vec3("lightPos", glm.value_ptr(light_pos))
