...
def main():
    ...
    lighting_shader = Shader("src/2.lighting/shaders/5.3.light_casters.vs", "src/2.lighting/shaders/5.3.light_casters.fs")
   ...
   # -- position attribute
    ...
    while not glfw.window_should_close(window):
        ...
        lighting_shader.use()
        lighting_shader.set_vec3("light.position", glm.value_ptr(camera.position))
        lighting_shader.set_vec3("light.direction", glm.value_ptr(camera.front))
