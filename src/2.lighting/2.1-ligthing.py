...
def main():
    ...
    light_cube_shader = Shader("src/2.lighting/shaders/1.lamp.vs", "src/2.lighting/shaders/1.lamp.fs")
    lighting_shader = Shader("src/2.lighting/shaders/2.1.basic_lighting.vs", "src/2.lighting/shaders/2.1.basic_lighting.fs")
